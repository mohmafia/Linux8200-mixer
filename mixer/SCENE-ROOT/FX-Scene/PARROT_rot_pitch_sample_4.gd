...
@export var my_id: String = " "     # mix-in-1 t/m 8 of master-A t/m C of FX bus enz
@export var my_type: String = " "      # INPUT of MASTER of FX of AUX of Aux return
@export var my_msg: String = " "       # PITCH, PAN, MIC-DRY enz
@export var error_prefix: String = "ROT-01" # [cite: 2026-02-04] English Error Code

# --- ROTATION SETTINGS ---
var dragging = false
var rotation_min = -152
var rotation_max = +152
var sensitivity = 2.5
