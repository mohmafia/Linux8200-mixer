...
@export var target_id: String = "Mix_CH1"

# LED Nodes
@onready var led_green := $Mic1_led_green
@onready var led_green2 := $Mic1_led_green2
@onready var led_yellow := $Mic1_led_yellow
@onready var led_red1 := $Mic1_led_red1
@onready var led_red2 := $Mic1_led_red2
@onready var clip_label := $Mic1_clip
