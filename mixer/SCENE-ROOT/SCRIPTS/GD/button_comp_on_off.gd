...
@export var target_id: String = "Mix_masterA" 
@export var button_type: String = "MASTER"    # INPUT, MASTER, of WORKAROUND
@export var button_msg: String = "COMP_ON"     # MUTE, COMP_ON, of SOLO
