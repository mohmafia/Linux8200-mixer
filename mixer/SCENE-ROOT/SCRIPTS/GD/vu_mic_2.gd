...
# --- CONFIGURATIE ---
@export var target_id: String = "Mix_CH2"
var error_prefix = "ERR-VU-02"
var is_windows = OS.get_name() == "Windows"

# --- LED NODES ---
@onready var led_green := $Mic2_led_green
@onready var led_green2 := $Mic2_led_green2
@onready var led_yellow := $Mic2_led_yellow
@onready var led_red1 := $Mic2_led_red1
@onready var led_red2 := $Mic2_led_red2
@onready var clip_label := $Mic2_clip
