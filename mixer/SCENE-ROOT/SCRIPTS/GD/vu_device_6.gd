...
# --- CONFIGURATIE ---
@export var target_id: String = "Mix_CH8"
var error_prefix = "ERR-VU-08"
var is_windows = OS.get_name() == "Windows"

# --- LED NODES ---
@onready var led_green := $DEVICE6_led_green
@onready var led_green2 := $DEVICE6_led_green2
@onready var led_yellow := $DEVICE6_led_yellow
@onready var led_red1 := $DEVICE6_led_red1
@onready var led_red2 := $DEVICE6_led_red2
@onready var clip_label := $DEVICE6_clip
