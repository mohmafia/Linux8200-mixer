...
# --- CONFIGURATIE ---
@export var target_id: String = "Mix_CH4"
var error_prefix = "ERR-VU-04"
var is_windows = OS.get_name() == "Windows"

# --- LED NODES ---
@onready var led_green := $DEVICE2_led_green
@onready var led_green2 := $DEVICE2_led_green2
@onready var led_yellow := $DEVICE2_led_yellow
@onready var led_red1 := $DEVICE2_led_red1
@onready var led_red2 := $DEVICE2_led_red2
@onready var clip_label := $DEVICE2_clip
