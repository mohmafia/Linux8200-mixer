...
@export var error_prefix: String = "FDR-02" # [cite: 2026-02-04]

# --- POSITION SETTINGS ---
const Y_START = 188.0  # Onder (0% / Groen)
const Y_END = 120.0    # Boven (100% / Rood)
...
@onready var my_led = $"led_fader_cv-1"
