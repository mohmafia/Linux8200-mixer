...
@export var button_msg: String = "lookahead"     # Bijv: ratio_4, ratio_8, attack, release
@export var error_prefix: String = "LN-BTN"    # [cite: 2026-02-04] Error Code Prefix

@export_group("Behavior")
@export var is_radio_button: bool = false       # Voor Ratio knoppen (slechts 1 aan)
@export var radio_group_name: String = "option" # Knoppen met dezelfde groep beïnvloeden elkaar
