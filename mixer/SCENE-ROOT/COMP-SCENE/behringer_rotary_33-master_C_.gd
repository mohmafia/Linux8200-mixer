...
@export var my_msg: String = "trigger_l"   # Bijv: threshold, ratio, attack, release
@export var error_prefix: String = "COMP-EXPANDER-L-01"  # [cite: 2026-02-04] English Error Code
