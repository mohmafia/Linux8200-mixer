...
@export var my_msg: String = "attack_l"   # Bijv: threshold, ratio, attack, release
@export var error_prefix: String = "COMP-ATTACK-L-01"  # [cite: 2026-02-04] English Error Code
