...
@export var my_msg: String = "peak_limiter_r"   # Bijv: threshold, ratio, attack, release
@export var error_prefix: String = "COMP-PEAK-LIMITER-R-01"  # [cite: 2026-02-04] English Error Code
