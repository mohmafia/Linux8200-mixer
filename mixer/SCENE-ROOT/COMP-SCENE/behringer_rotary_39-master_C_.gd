...
@export var my_id: String = "comp-C"    # mix-in-1 t/m 8 of master-A t/m C
@export var my_type: String = "MASTER"      # INPUT of MASTER
@export var my_msg: String = "enhancer_level_l"   # Bijv: threshold, ratio, attack, release
@export var error_prefix: String = "COMP-ENHANCER-LEVEL-L-01"  # [cite: 2026-02-04] English Error Code
